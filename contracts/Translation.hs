...
sTrans e (H.Pred x u) = return $ F.Or [(eTrans e `F.Eq` F.Var F.UNR) ,F.And [(F.CF $ eTrans e),
                                                                 (F.CF $ eTrans u') , (F.Not $ eTrans u' `F.Eq` (F.Var $ F.Regular "false"))]] -- The data constructor False.
