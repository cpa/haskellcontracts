...
to a first-order \note[nc]{this is a note} logic theory and
 then use an \annote[ncc]{this is an annote}{automated theorem prover}
\add[nc]{new text} to check the \remove[nc]{consistency} of the theory.
\change[nc]{Old text}{New text}.
Consider:
\begin{verbatim}
...
\ncnote*{Thi is  a note}{Now that we translated} everything to first-order logic, we can ask the
